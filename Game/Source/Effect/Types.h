...
namespace app
{
	...
	static EffectInformation effectInformation[static_cast<uint8_t>(EnEffectKind::Max)] =
	{
		...
		EffectInformation(u"Assets/effect/ult/clusterUltBegin.efk", 150.0f),
		EffectInformation(u"Assets/effect/ult/clusterUltEnd.efk", 150.0f),
		EffectInformation(u"Assets/effect/ult/triangleUltBegin.efk", 150.0f),
		EffectInformation(u"Assets/effect/ult/triangleUltEnd.efk", 150.0f),
		EffectInformation(u"Assets/effect/ult/scatterUlt.efk", 150.0f),
		EffectInformation(u"Assets/effect/ult/circleUltBegin.efk", 150.0f),
		EffectInformation(u"Assets/effect/ult/circleUltEnd.efk", 150.0f),
	};
}