...
namespace app
{
	namespace util
	{
		...
		public:
			...
			/** 無効なQuaternion値 */
			static const Quaternion InvalidQuaternion;
			/** 無効な拡大値Vector3値 */
		...
		public:
			...
			static std::string ToString(
				const nlohmann::json& json,
				const char* key,
				std::string invalid = InvalidString
			);
			...
			static Vector2 ToVector2(
				const nlohmann::json& json,
				const char* key,
				Vector2 invalid = InvalidVector2
			);
			...
			static Vector3 ToVector3(
				...
				const char* key,
				bool isScale = false,
				Vector3 invalid = InvalidVector3
			);
			...
			static Quaternion ToRotation(
				...
				const char* key,
				bool isDegree = true,
				Quaternion invalid = InvalidQuaternion);
			...
			static Vector4 ToVector4(
				...
				const char* key,
				bool isConvert = true,
				Vector4 invalid = InvalidVector4
			);
			 ...
			 */
			static FloatRange ToFloatRange(
				const nlohmann::json& json,
				const char* key
			);
