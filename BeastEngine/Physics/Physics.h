...
namespace nsBeastEngine
{
	namespace nsCollision
	{
		...
		public:
			 ...
			 * NOTE: 内部用あるいは上級者用
			 */
			bool ConvexSweepTest(const btConvexShape* m_shape, const Vector3& start, const Vector3& end, SweepHit& result, const uint32_t filterMask = ALL_COLLISION_ATTRIBUTE_MASK, std::function<bool(const btCollisionObject&)> filterCallback = nullptr) const;
